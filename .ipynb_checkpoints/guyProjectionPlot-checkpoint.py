...
def _sphere_creation(simulation_galaxy,snapshots,output_directory):
...
def angular_momentum(simulation_galaxy,snapshots,output_directory):
    sps,ts = _sphere_creation(simulation_galaxy,snapshots,output_directory)
    L_disk_norms = {}
    galaxy = simulation_galaxy.split("_res")[0]
